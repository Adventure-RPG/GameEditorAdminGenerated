    ...
    ngOnInit() {
        this.items = [
            ...
            { label: 'Entities', icon: 'fa-search', items: [
                    {label: 'CategoryType Search', routerLink: ['/categoryType-list']},
                    {label: 'CategoryType Create', routerLink: ['/categoryType/new']},
                    {label: 'Character Search', routerLink: ['/character-list']},
                    {label: 'Character Create', routerLink: ['/character/new']},
                    {label: 'Characteristic Search', routerLink: ['/characteristic-list']},
                    {label: 'Characteristic Create', routerLink: ['/characteristic/new']},
                    {label: 'Gender Search', routerLink: ['/gender-list']},
                    {label: 'Gender Create', routerLink: ['/gender/new']},
                    {label: 'Model Search', routerLink: ['/model-list']},
                    {label: 'Model Create', routerLink: ['/model/new']},
                    {label: 'Race Search', routerLink: ['/race-list']},
                    {label: 'Race Create', routerLink: ['/race/new']},
                    {label: 'RaceOption Search', routerLink: ['/raceOption-list']},
                    {label: 'RaceOption Create', routerLink: ['/raceOption/new']},
                    {label: 'Script Search', routerLink: ['/script-list']},
                    {label: 'Script Create', routerLink: ['/script/new']},
                    {label: 'Skill Search', routerLink: ['/skill-list']},
                    {label: 'Skill Create', routerLink: ['/skill/new']},

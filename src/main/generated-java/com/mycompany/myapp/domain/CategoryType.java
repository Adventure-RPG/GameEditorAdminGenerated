...
public class CategoryType implements Identifiable<Integer>, Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = Logger.getLogger(CategoryType.class.getName());
    ...
    public String entityClassName() {
        return CategoryType.class.getSimpleName();
    }
    ...
    public CategoryType id(Integer id) {
        setId(id);
        return this;
    }
    ...
    public CategoryType creationDate(Instant creationDate) {
    ...
    public CategoryType creationAuthor(String creationAuthor) {
    ...
    public CategoryType lastModificationDate(Instant lastModificationDate) {
    ...
    public CategoryType lastModificationAuthor(String lastModificationAuthor) {
    ...
    public CategoryType version(Integer version) {
        setVersion(version);
        return this;
    }
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // many-to-one: CategoryType.cat ==> CategoryType.id
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    /**
     * Set the {@link #cat} without adding this CategoryType instance on the passed {@link #cat}
     */
    public void setCat(CategoryType cat) {
        this.cat = cat;
    }

    public CategoryType cat(CategoryType cat) {
        setCat(cat);
        return this;
    }
     ...
     */
    public CategoryType withDefaults() {
        return this;
    }
    ...
    public boolean equals(Object other) {
        return this == other || (other instanceof CategoryType && hashCode() == other.hashCode());
    }
    ...
    /**
     * Construct a readable string representation for this CategoryType instance.
